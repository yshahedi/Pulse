...
// Worker-telemetry monitor. This is the original standalone dashboard view,
// now mounted as the "Monitoring" tab of the admin panel. It still talks to the
// metrics WebSocket on :4002 (independent of the :4001 admin API).
...
export function Monitor() {
  ...
  return (
    <div>
      <div className="conn" style={{ justifyContent: 'flex-end', marginBottom: 12 }}>
      ...
      {!connected && (
        <div className="banner err">
          Metrics backend unreachable at {url} — Pulse is down or built without <code>-DPULSE_METRICS</code>.
        </div>
      )}
      {connected && !enabled && (
